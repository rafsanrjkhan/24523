                    ...
                    <div class="card">
			                ...
			                <div class="card-body">
			                	<form action="slider_edit_processor.php" method="post" enctype="multipart/form-data" >
                                        <input name="id" type="hidden" class="form-control"  value="<?=$aslide->id?>" />
										<input name="uuid" type="hidden" class="form-control"  value="<?=$aslide->uuid?>" />
									<div class="form-group">
										<label>Title</label>
										<input name="title" type="text" class="form-control" placeholder="" value="<?=$aslide->title?>">
									</div>

									<div class="form-group">
										<label>Caption</label>
										<input name="caption" type="text" class="form-control" placeholder="" value="<?=$aslide->caption?>">
									</div>

									<div class="form-group">
										<label>Alt</label>
										<input name="alt" type="text" class="form-control" placeholder="" value="<?=$aslide->alt?>">
									</div>
                                    ...
                                    <div class="form-group">
										...
										<img src="<?=$webportal.'uploads/'.$aslide->src?>" alt="" height="100" width="100">
										<input type="file" name="old_picture" class="form-control" placeholder="Picture" value="<?=$webportal.'uploads/'.$aslide->src?>">
									</div>
